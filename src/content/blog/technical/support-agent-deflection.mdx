...
Most teams building AI support agents hit a ceiling. The agent deflects 30–40% of incoming tickets, leadership pushes for more, and the team runs more evals and swaps models, but the number barely moves. [Intercom's data](https://fin.ai/customers) across thousands of deployments puts the average resolution rate at 51–66%; Salesforce quotes 30% as the out-of-the-box target.
...
We're happy to do this support agent failure mode audit for you — [request it here](/free-tools/support-agent-audit).
