...
- **Pinned policy/identity memory** ("this assistant must always follow these rules under these circumstances"): [Letta's in-context memory blocks](https://docs.letta.com/concepts/memory) are designed for this.
