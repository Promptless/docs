...
Git is consistently the hardest part of docs-as-code transitions, harder than learning Markdown or configuring a static site generator. [Tom Johnson](https://idratherbewriting.com/learnapidoc/pubapis_switching_to_docs_as_code.html) waited a full year before engineering resources were available for the migration, and still describes it as a multi-year process. A technical writer with no Git background will spend more time managing the system than writing documentation.
...
[HubSpot](https://developers.hubspot.com/blog/optimizing-developer-docs-in-the-age-of-ai-our-mintlify-migration-story) rebuilt their documentation platform internally three times before moving to Mintlify. [Tom Johnson's migration](https://idratherbewriting.com/learnapidoc/pubapis_switching_to_docs_as_code.html) involved a year of planning followed by months of writers maintaining dual systems. These are normal timelines for a migration at scale.
