...
<Frame caption="Claude Code successfully retrieving llms.txt from clerk.com — a first in 1000+ Claude Code agent sessions, illustrating how uncommon llms.txt adoption remains even among developer-facing companies.">
  <img src="https://promptless-customer-doc-assets.s3.us-east-2.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/claude-code-llms-txt-fetch-0ea16b7a.png" alt="Terminal output showing Claude Code fetching URLs from clerk.com, with most returning 404 errors but llms.txt successfully returning 9.5KB" />
</Frame>
