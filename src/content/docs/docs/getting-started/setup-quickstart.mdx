...
<Frame caption="Connect your Slack workspace to enable notifications and direct support">
  ![Connect Slack step showing the Slack integration panel with benefits and connection button](https://promptless-customer-doc-assets.s3.us-east-2.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/setup-wizard-connect-slack-eb8ef83a.png)
</Frame>
