...
- **GitHub PRs**: Auto-trigger when pull requests are opened
- **GitHub Commits**: Auto-trigger on direct commits to default branches
- **Bitbucket PRs**: Auto-trigger when pull requests are opened
- **GitLab MRs**: Auto-trigger when merge requests are opened
