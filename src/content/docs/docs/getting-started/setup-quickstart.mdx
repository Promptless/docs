...
{/* test {"testId": "setup-quickstart-wizard-ui"} */}
{/* step {"goTo": {"url": "https://app.gopromptless.ai", "timeout": 15000}} */}
{/* step {"find": {"text": "Connect Slack", "timeout": 10000}} */}
{/* step {"find": {"text": "Connect docs", "timeout": 5000}} */}
{/* step {"find": {"text": "Configure triggers", "timeout": 5000}} */}
{/* step {"find": {"text": "Additional context", "timeout": 5000}} */}
{/* step {"find": {"text": "Agent preferences", "timeout": 5000}} */}
{/* step {"find": {"text": "Start trial", "timeout": 5000}} */}
{/* test end */}
