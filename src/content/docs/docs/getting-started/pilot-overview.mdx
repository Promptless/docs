...
<Steps>
  <Step title="Understand your Promptless setup">
    Review your configuration and how [triggers](/docs/configuring-promptless/triggers), [context sources](/docs/configuring-promptless/context-sources), and [documentation platforms](/docs/configuring-promptless/doc-collections/git-hub-repos-docs-as-code) work for your team
  </Step>
