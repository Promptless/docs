...
<section id="core-concepts-workflow" class="pl-site-steps is-compact" data-sticky-heading="false">
  <div class="pl-site-step-list">
    ...
    <article class="pl-site-step" id="documentation-platforms-receive-updates">
      ...
      <ul>
        <li>
          <strong>Git-hosted Platforms</strong>: Most common setup where docs are stored in Git and synced to hosting
          providers
        </li>
        <li>
          <strong>Direct Platform Integration</strong>: Beta support for publishing directly to Zendesk and Intercom
        </li>
        <li>
          <strong>Multi-platform Publishing</strong>: Single trigger can update multiple documentation platforms
          simultaneously
        </li>
      </ul>
      <p>
        Learn more in <a href="/docs/configuring-promptless/doc-collections">Configuring Promptless → Doc Collections</a>.
      </p>
    </article>
  </div>
</section>
