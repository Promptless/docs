...
<Steps>
  ...
  <Step title="Wait for Progress Updates">
    Promptless sends you a progress notification while it analyzes the thread.
  </Step>

  <Step title="Review Generated Content">
    Promptless DMs you when finished. If Promptless determines no documentation update is needed, it lets you know.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Receive Acknowledgment">
    Promptless acknowledges your mention in the thread to confirm it received your request.
  </Step>

  <Step title="Review Results">
    Promptless analyzes the entire thread context and replies in the same thread when finished. If no documentation update is needed, Promptless lets you know instead of staying silent.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Wait for Promptless Reply">
    Promptless replies in the DM with documentation updates. If no update is needed, Promptless lets you know.
  </Step>
</Steps>
