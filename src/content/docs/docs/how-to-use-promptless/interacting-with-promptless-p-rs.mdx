...
## What happens after you leave feedback

When you leave a comment or submit a review on a Promptless documentation PR:

1. **Acknowledgment**: Promptless adds an eyes reaction to your comment to confirm it's processing your request.

2. **Processing**: Promptless analyzes your feedback along with the full PR context.

3. **Response**: Promptless either pushes new commits addressing your feedback, or posts a comment explaining that no documentation changes were needed.

If Promptless determines your feedback doesn't require documentation changes (for example, if you asked about something already addressed or outside the scope of the docs), you'll see a message: "I've processed your request, but no documentation changes were needed."
