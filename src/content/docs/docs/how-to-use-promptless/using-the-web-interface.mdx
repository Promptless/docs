...
When viewing trigger details, expand the session trace to see how Promptless processed the trigger. The trace shows:

- **System Prompt**: The instructions that guided Promptless during processing
- **Available Tools**: The tools Promptless could use to research and generate documentation, with descriptions
- **MCP Server Status**: Connection status for tool servers

This information helps you understand Promptless's decision-making process and troubleshoot unexpected results.
