...
## Viewing Your Stored Feedback

When you choose to remember feedback for future suggestions, Promptless stores your preferences in your organization's Knowledge Base. To view what Promptless has learned from your feedback:

1. Go to [app.gopromptless.ai](https://app.gopromptless.ai)
2. Navigate to the **Knowledge Base** page from the sidebar

The Knowledge Base shows all the preferences and guidelines Promptless has learned from your team's feedback. This includes style preferences, content guidelines, and any specific instructions you've provided. You can review and edit these entries to fine-tune how Promptless generates future suggestions.
