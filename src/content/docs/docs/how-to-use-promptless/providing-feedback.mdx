...
{/* step {"wait": 3000} */}
{/* step {"find": "[data-testid='suggestion-row'], .suggestion-row, tr[class*='suggestion'], a[href*='/suggestions/']", "click": true, "timeout": 10000} */}
{/* step {"wait": 3000} */}
{/* step {"find": "[data-testid='request-changes-button'], button:has-text('Request Changes'), button:contains('Request Changes')", "click": true, "timeout": 10000} */}
{/* step {"wait": 2000} */}
{/* step {"find": "[data-testid='submit-request-button'], button:has-text('Submit Request'), button:contains('Submit Request')", "timeout": 10000} */}
