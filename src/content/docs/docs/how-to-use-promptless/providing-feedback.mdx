...
[comment]: # (test start {"id": "request-changes-button", "description": "Verify the Request Changes modal shows Submit Request button"})
[comment]: # (step {"action": "goTo", "url": "https://app.gopromptless.ai/suggestions"})
[comment]: # (step {"action": "wait", "duration": 3000})
[comment]: # (step {"action": "find", "selector": "[data-testid='suggestion-row'], .suggestion-row, tr[class*='suggestion'], a[href*='/suggestions/']", "click": true, "timeout": 10000})
[comment]: # (step {"action": "wait", "duration": 3000})
[comment]: # (step {"action": "find", "selector": "[data-testid='request-changes-button'], button:has-text('Request Changes'), button:contains('Request Changes')", "click": true, "timeout": 10000})
[comment]: # (step {"action": "wait", "duration": 2000})
[comment]: # (step {"action": "find", "selector": "[data-testid='submit-request-button'], button:has-text('Submit Request'), button:contains('Submit Request')", "timeout": 10000})
[comment]: # (test end)
