...
- **[Triggers](/docs/configuring-promptless/triggers/microsoft-teams-messages-beta)**: Tag @Promptless in channels or DMs to trigger documentation updates

For more details about configuration, see [Microsoft Teams Triggers](/docs/configuring-promptless/triggers/microsoft-teams-messages-beta).
