...
slug: docs/integrations/zendesk-integration-beta
sidebar:
  hidden: false
  order: 35
---
...
<Info>
The Zendesk integration is currently in beta. Contact [help@gopromptless.ai](mailto:help@gopromptless.ai) if you have feedback or need assistance.
</Info>
