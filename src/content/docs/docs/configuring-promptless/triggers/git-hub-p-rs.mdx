...
<Frame caption="Suppress comments option in project configuration">
  <img src="https://promptless-customer-doc-assets.s3.us-east-2.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/suppress-pr-comments-config-dd9352ff.png" alt="Edit Project modal showing the Suppress comments from Promptless on PRs checkbox in the Trigger configuration section" />
</Frame>
