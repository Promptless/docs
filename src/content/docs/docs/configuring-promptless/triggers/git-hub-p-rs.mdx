...
<Tip>
Slack notifications are separate from source PR comments and are always sent according to your [notification settings](/docs/configuring-promptless/customizing-notifications).
</Tip>
...
<Frame caption="Suppress comments option in project configuration">
  <img src="https://promptless-customer-doc-assets.s3.us-east-2.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/new-project-suppress-pr-comments-6f5bc016.png" alt="New Project modal showing the Suppress comments from Promptless on PRs checkbox in the Trigger configuration section" />
</Frame>

This option is useful for teams that:
- Have strict policies about automated PR comments
- Prefer to track documentation updates only through Slack notifications or the Promptless dashboard
- Want to reduce noise on busy PRs
