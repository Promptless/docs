...
Enable the **suppress PR comments** option in your project configuration to prevent comments on source PRs. Documentation suggestions are still created normally.
