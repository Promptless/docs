...
<Note>
Replay is not available for first-approval triggers. To re-run documentation analysis on a PR, use the Slack or web interface to manually request an update.
</Note>
