...
<Frame caption="The Doc Collections page shows your connected repositories and their configuration">
  <img src="https://promptless-customer-doc-assets.s3.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/doc-collections-page-18d1c142.png" alt="Doc Collections page showing repository configurations with Provider, Published URL, Config File, Include Dirs, and Branch fields" />
</Frame>
