...
<Frame caption="A doc collection showing its configuration settings">
  <img src="https://promptless-customer-doc-assets.s3.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/doc-collection-card-9924ea9f.png" alt="Doc Collections page showing a configured doc collection with provider, published URL, config file, include directories, and branch settings" />
</Frame>
