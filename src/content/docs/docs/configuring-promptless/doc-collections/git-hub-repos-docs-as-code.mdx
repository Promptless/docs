...
<Frame caption="Doc Collections page showing configured documentation repositories">
  <img src="https://promptless-customer-doc-assets.s3.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/doc-collections-page-88ca0573.png" alt="Doc Collection configuration interface showing repository name, provider, published URL, config file, include directories, branch, and status indicators" />
</Frame>
