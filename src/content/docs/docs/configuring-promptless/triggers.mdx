...
Triggers are the starting point for automated documentation in Promptless. They watch for key events across your development workflow—like a pull request being opened, a Slack conversation about a new feature, or a support ticket revealing a documentation gap—and automatically kick off the process of keeping your docs up to date.

Without triggers, documentation often falls behind because updating it requires someone to remember, find time, and manually make changes. Triggers solve this by connecting documentation directly to the events that make updates necessary. When something changes in your codebase or when your team discusses something that should be documented, Promptless is already listening.

On this page, you'll find an overview of the available trigger types, how they work, and how to configure them for your projects.
...
<CardGroup cols={2}>
  ...
  <Card title="Microsoft Teams (Beta)" iconSrc="/assets/microsoft-teams-logo.svg" iconAlt="Microsoft Teams logo" href="/docs/configuring-promptless/triggers/microsoft-teams-messages-beta">
