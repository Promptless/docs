...
<CardGroup cols={2}>
  ...
  <Card title="Microsoft Teams" iconSrc="/assets/microsoft-teams-logo.svg" iconAlt="Microsoft Teams logo" href="/docs/configuring-promptless/triggers/microsoft-teams-messages">
