...
<CardGroup cols={2}>
  <Card title="GitHub PRs" iconSrc="/assets/github-logo.svg" iconAlt="GitHub logo" href="/docs/configuring-promptless/triggers/github-prs">
    Automatically triggered when pull requests are opened in your GitHub repositories
  </Card>
  
  <Card title="GitHub Commits" iconSrc="/assets/github-logo.svg" iconAlt="GitHub logo" href="/docs/configuring-promptless/triggers/github-commits">
