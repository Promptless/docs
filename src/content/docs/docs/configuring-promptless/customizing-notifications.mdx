...
<Tip>
  Promptless automatically detects protected branches in your documentation repository. When detected, Slack notifications show "Open PR" or "View PR" buttons instead of "Publish" to prevent merge errors.
</Tip>
