...
<CardGroup cols={2}>
  ...
  <Card title="Team Collaboration" icon="fa-regular fa-users">
    Bridges communication gaps between product, engineering, and technical writing teams by automatically detecting when releases impact docs, eliminating the breakdowns that leave writers unaware of critical changes.
  </Card>
</CardGroup>
