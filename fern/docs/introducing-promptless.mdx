...
Promptless 1.0 represents a major leap forward in how teams maintain documentation. The 1.0 release brings improvements to both suggestion quality and new capabilities for keeping docs current. Voice Match fine-tunes a custom model based on your existing docs so AI-generated content sounds natural and matches your established tone. Promptless can now automatically capture and update screenshots when your UI changes, passively monitor Slack channels to draft updates from customer conversations, and automatically merge documentation PRs for complete end-to-end automation.
