...
Promptless 1.0 brings better suggestion quality and new capabilities for keeping docs current.

Voice Match fine-tunes a custom model based on your existing documentation so AI-generated content sounds natural and matches your tone. Every suggestion now includes citations showing exactly where information came from—specific GitHub files, Slack threads, or support conversations—so you can verify sources and understand the reasoning behind each change.

Promptless can now automatically capture and update screenshots when your UI changes, passively monitor Slack channels to draft updates from customer conversations, and automatically merge documentation PRs for complete end-to-end automation. This means Promptless can draft docs from more sources and handle more of the documentation workflow without manual intervention.
