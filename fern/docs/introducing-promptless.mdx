...
Promptless 1.0 represents a major leap forward in Promptless's capabilities, dramatically improving suggestion quality and bringing new abilities to keep different types of content current.
...
* **Auto-updating screenshots.** When features that impact your UI are deployed, Promptless browses your web app and regenerates screenshots from scratch.
* **Brand-new suggestion reviewing experience.** Promptless provides citations, tells you its reasoning, and makes it easy to quickly validate that suggestions are correct.
