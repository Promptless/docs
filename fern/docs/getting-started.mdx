...
<ParamField path="Auto-publish" type="boolean">
  Automatically create PRs with documentation changes (GitHub/Bitbucket only). Optionally enable auto-merge (nested checkbox) to automatically merge PRs as soon as they're created.
</ParamField>
