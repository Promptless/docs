...
**GitHub/Bitbucket Triggers**: Automatically runs when PRs are opened in specified source repositories. Enable the auto-publish option to automatically create documentation PRs instead of requiring manual review.
