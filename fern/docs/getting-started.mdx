...
<ParamField path="Replay Recent PRs" type="boolean">
  Analyze PRs from the last 30 days when creating your project to generate suggestions based on recent code changes (GitHub/Bitbucket only)
</ParamField>
