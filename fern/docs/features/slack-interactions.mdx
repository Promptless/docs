...
<Tip title="Best Practices">
  - Include clear instructions about what to do with the attached files
  - Reference specific attachments if there are multiple files in the thread
  - Provide context about why the image or file is relevant to the documentation
</Tip>
