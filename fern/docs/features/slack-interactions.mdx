...
Promptless integrates deeply with Slack to enable documentation generation directly from your team conversations. Whether you're discussing internal processes or external customer issues, you can capture these discussions and turn them into documentation without leaving Slack.
...
Use Slack's message actions to quickly trigger documentation updates from any message or thread. This is best used in slack connect channels, where you don't want to interrupt the flow of the conversation.

<Steps>
  <Step title="Find the Message">
    Navigate to any Slack message that contains information relevant to your documentation.
  </Step>

  <Step title="Access Message Actions">
    Click the three dots (⋯) menu on the message to open the message actions menu.
  </Step>
