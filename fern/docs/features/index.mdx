...
<CardGroup cols={1}>
  ...
  <Card title="Workflow Management" icon="regular tasks" href="/how-to-use-promptless/workflow-management">
    Assign suggestions to team members, organize with labels, and filter suggestions to streamline collaboration and release planning.
  </Card>
</CardGroup>
