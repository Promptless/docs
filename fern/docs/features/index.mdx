...
<CardGroup cols={1}>
  <Card title="Working with Slack" iconSrc="/assets/squarelogo.png" iconAlt="Promptless logo" href="/how-to-use-promptless/working-with-slack">
  ...
  <Card title="Interacting with Promptless PRs" iconSrc="/assets/squarelogo.png" iconAlt="Promptless logo" href="/how-to-use-promptless/interacting-with-promptless-p-rs">
    Provide follow-up instructions through GitHub PR comments and reviews after your documentation PR is opened.
  </Card>

  <Card title="Using the Web Interface" iconSrc="/assets/squarelogo.png" iconAlt="Promptless logo" href="/how-to-use-promptless/using-the-web-interface">
