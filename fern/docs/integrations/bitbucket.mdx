...
Promptless automatically sets up webhooks to monitor your pull requests. When changes are detected, Promptless generates documentation updates.
...
Need help modifying or troubleshooting webhook behavior? Reach out to [help@gopromptless.ai](mailto:help@gopromptless.ai).
