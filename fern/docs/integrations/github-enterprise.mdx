...
<Info>
You'll only see the "Connect GitHub Enterprise" option after the Promptless team has successfully configured your integration with the credentials and settings you provided in Step 8.
</Info>
