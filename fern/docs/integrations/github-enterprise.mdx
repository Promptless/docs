...
<Info>
The primary egress IP address for Promptless infrastructure is `3.143.177.103` (NAT gateway). This is the IP address that will appear in your GitHub Enterprise logs for API requests and webhook communications.
</Info>
