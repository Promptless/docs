...
<Warning>
This setup is required for GitHub Enterprise Server instances and GitHub Enterprise Cloud organizations that don't allow third-party GitHub Apps. For standard GitHub.com organizations, use the [standard GitHub integration](./github-integration) instead.
</Warning>
