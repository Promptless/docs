...
<Warning>
This setup is required for GitHub Enterprise Server instances and GitHub Enterprise Cloud organizations that don't allow third-party GitHub Apps. For standard GitHub.com organizations, use the [standard GitHub integration](./github.mdx) instead.
</Warning>
...
<ParamField path="GitHub App name" type="string" required={true}>
  Enter a descriptive name like "Promptless Enterprise" or "Promptless (Your Company Name)"
</ParamField>

<ParamField path="Description" type="string" required={true}>
  Use: "Promptless keeps your technical guides up-to-date using AI."
</ParamField>

<ParamField path="Homepage URL" type="string" required={true}>
  Set to: `https://gopromptless.ai`
</ParamField>
...
<ParamField path="Callback URL" type="string" required={true}>
  Set to: `https://app.gopromptless.ai/integrations`
</ParamField>

<ParamField path="Setup URL (Post installation)" type="string" required={true}>
  Set to: `https://app.gopromptless.ai/integrations/github-redirect`
</ParamField>
...
<ParamField path="Webhook URL" type="string" required={true}>
  Set to: `https://api.gopromptless.ai/integrations/github/events`
</ParamField>

<ParamField path="Webhook secret" type="string" required={false}>
  Leave this field empty or generate a secure secret if required by your security policies
</ParamField>

<ParamField path="SSL verification" type="boolean" required={true}>
  Enable SSL verification (recommended for security)
</ParamField>

## Step 4: Configure Repository Permissions

Promptless requires specific repository permissions to function properly:

<Frame>
  <img src="https://promptless-customer-doc-assets.s3.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/b5b5ff40-d884-4086-acb6-4bb2973bfd97-github-enterprise-repository-permissions.png" alt="GitHub Enterprise Repository Permissions" />
</Frame>

### Required Repository Permissions

<AccordionGroup>
  <Accordion title="Pull Requests - Read and Write">
    Allows Promptless to:
  ...
  <Accordion title="Contents - Read and Write">
    Allows Promptless to:
  ...
  <Accordion title="Webhooks - Read and Write">
    Allows Promptless to:
    - Manage webhook configurations
    - Receive real-time notifications of repository events
  </Accordion>

  <Accordion title="Commit Statuses - Read Only">
    Allows Promptless to:
...
<Frame>
  <img src="https://promptless-customer-doc-assets.s3.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/b5b5ff40-d884-4086-acb6-4bb2973bfd97-github-enterprise-webhook-events.png" alt="GitHub Enterprise Webhook Events" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Pull Request" icon="git-pull-request">
    Triggers when pull requests are opened, updated, or closed
  </Card>

  <Card title="Pull Request Review" icon="eye">
    Triggers when pull request reviews are submitted
  </Card>

  <Card title="Pull Request Review Thread" icon="message-dots">
    Triggers when review threads are created or updated
  </Card>

  <Card title="Pull Request Review Comment" icon="comment">
    Triggers when individual review comments are made
  </Card>

  <Card title="Push" icon="upload">
    Triggers when code is pushed to repositories
  </Card>

  <Card title="Release" icon="tag">
    Triggers when releases are created or updated
  </Card>

  <Card title="Repository" icon="folder">
    Triggers when repository settings change
  </Card>
</CardGroup>
