...
- **Description** (required): Use: "Promptless keeps your technical guides up-to-date using AI."
- **Homepage URL** (required): Set to: `https://gopromptless.ai`
...
- **Callback URL** (required): Set to: `https://app.gopromptless.ai/integrations`
- **Setup URL (Post installation)** (required): Set to: `https://app.gopromptless.ai/integrations/github-redirect`
...
- **Webhook URL** (required): Set to: `https://api.gopromptless.ai/integrations/github/events`
