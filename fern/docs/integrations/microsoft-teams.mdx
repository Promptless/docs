...
If your organization requires Promptless to monitor all messages automatically (without requiring @Promptless tags), this can be configured as a custom setup. Contact [help@gopromptless.ai](mailto:help@gopromptless.ai) to discuss enabling comprehensive message monitoring for your Teams integration.
