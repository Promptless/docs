...
4. Click "Accept", and you'll be redirected to Promptless, verify that Jira is connected. If you don't see the option to accept, you may not have the required permissions. You can invite your org's Jira admin to Promptless. For more information about adding new members, see our [FAQ](/frequently-asked-questions/frequently-asked-questions#how-do-i-add-team-members-to-my-account).
<Frame>
  <img src="https://promptless-customer-doc-assets.s3.amazonaws.com/docs-images/org_2lvkgU9erOFxYhtEVVC0ymPrPdF/e3bdab51-fb59-4971-aaac-32ed7dddf07b-jira-project-configuration.png" alt="Jira project configuration showing connected status and accessible projects" />
</Frame>
