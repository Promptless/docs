...
4. Click "Accept", and you'll be redirected to Promptless, verify that Jira is connected. If you don't see the option to accept, you may not have the required permissions. You can invite your org's Jira admin to Promptless. For more information about adding new members, see our [Account Management](/docs/account-management) page.
<Frame>
