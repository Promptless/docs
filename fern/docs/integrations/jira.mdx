...
<Steps>
  <Step title="Invite the account to Jira">
    In your Jira workspace, click "Invite people to Jira" and invite the new account.
    
    <Frame>
      **[SCREENSHOT: Jira invite screen]**
    </Frame>
  </Step>

  <Step title="Accept the invitation">
    Accept the email invite from Jira for your new account. You'll need to sign out of your existing Jira account to accept this invite.
    
    <Tip>
      Use the name "Promptless" (not your personal name) when setting up the account. This name will appear in any audit logs.
    </Tip>
    
    <Frame>
      **[SCREENSHOT: Jira account setup screen]**
    </Frame>
  </Step>

  <Step title="Connect to Promptless">
    Make sure you're logged into the Jira account you created for Promptless (not your personal account) when completing the OAuth connection in Promptless.
  </Step>
</Steps>

<Warning>
  Only add this Jira account to one workspace to maintain clear boundaries and permissions.
</Warning>
