...
<Steps>
  ...
  <Step title="Accept the invitation">
    ...
    Once complete, you'll see the account listed as ACTIVE. It might take a few minutes for the status to update from INVITED to ACTIVE after you accept the invite.
