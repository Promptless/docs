...
After granting permission, you can manage Promptless access through your Atlassian Connected Apps settings:
<Frame>
...
After connecting Jira, you can configure which projects you'd like Promptless to search in when setting up a Project in the [projects page](https://app.gopromptless.ai/projects).

For example, in a project setup, Promptless will only search within the selected Jira projects for relevant issues and tickets.
