...
<Steps>
  ...
  <Step title="Accept the invitation">
    Check the email inbox for your Promptless account and accept the invitation.
    ...
    When setting up the account, use the name "Promptless Bot" so it's clear in audit logs.
