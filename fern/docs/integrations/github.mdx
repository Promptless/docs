...
Connect multiple GitHub organizations to a single Promptless account. Each organization shows up as its own card on the integrations page with separate repository lists and management controls.

To connect an additional organization:

1. Navigate to the [integrations page](https://app.gopromptless.ai/integrations)
2. Click "Connect another GitHub Org" 
3. Follow the same installation flow to authorize Promptless for the new organization
4. Select which repositories to grant access to

When creating or editing projects, you'll select your GitHub organization from a dropdown (e.g., "Github (Promptless)" or "Github (YourCompany)"), then choose from that organization's repositories. This lets you work across multiple organizations or manage both company and personal projects in one place.
...
### Can I use Promptless with both my company and personal GitHub accounts?

Yes! You can connect multiple GitHub organizations to a single Promptless account. Each organization shows up as its own card on the integrations page with its own repository list and management controls. When you create a project, select the organization from the dropdown, then choose repositories from that org. Great for managing both company and personal projects, or working across multiple organizations.
