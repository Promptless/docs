...
<Info>
**GitHub Enterprise Users**: If you're using GitHub Enterprise Server or GitHub Enterprise Cloud with restricted third-party app access, see our [GitHub Enterprise Setup Guide](./github-enterprise.mdx) for custom GitHub App configuration instructions.
</Info>
