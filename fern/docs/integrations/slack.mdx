...
When you connect Slack, we create a dedicated channel for your team:

- **Notifications**: Documentation suggestion updates from Promptless
- **Direct support**: Questions and feedback with the Promptless team via Slack Connect

Accept the Slack Connect invitation after connecting to enable direct support. You can invite other team members to the channel.
