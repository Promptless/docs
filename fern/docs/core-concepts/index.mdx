...
The diagram below illustrates how triggers, context sources, and doc collections interact within the Promptless ecosystem:
...
### 3. Documentation Collections Receive Updates

**Documentation Collections** are where the final documentation updates are published:
