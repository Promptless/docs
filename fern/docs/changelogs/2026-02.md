...
* **Smarter Follow-Up Handling for Open-Source Projects:** When you comment on a PR or issue that already has an open Promptless suggestion, your follow-up request now updates the existing suggestion instead of creating a duplicate.
