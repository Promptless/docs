...
* **Enhanced Suggestion Filtering:** Added 'PR Open' option to the suggestions dashboard status filters, making it easier to find suggestions that have been published as pull requests without typing search queries manually.
