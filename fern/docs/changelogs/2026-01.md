...
* **Consistent GitHub Trigger Icons:** The GitHub icon and link to the source PR or issue now appears for all GitHub-based triggers on the Change History page—including GitHub Enterprise PRs, merged PRs, and GitHub Issues. Previously, only regular GitHub PRs showed the icon.
