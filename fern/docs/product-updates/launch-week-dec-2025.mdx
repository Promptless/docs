...
### Why We Turned Down Viral Growth

When designing this feature, several people suggested we let Promptless post documentation updates directly in Slack Connect channels with customers—putting Promptless in front of thousands of potential users overnight.

But we use Slack Connect with our customers too. In the middle of an important support conversation, the last thing anyone wants is a bot interrupting with doc updates. So we made Promptless invisible.
