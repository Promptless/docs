...
<Steps>
  ...
  <Step title="Connect documentation platforms">
    Connect your documentation CMS or publishing platform, whether on Github (e.g. if you use Mintlify, Fern, Readme, Docusaurus, etc) or on a CMS like Zendesk.
  </Step>
...
**9-10: High Quality, Ready to Publish**  
Most suggestions from Promptless are relevant, and typically can be accepted with little to no edits.

**7-8: Good Quality, Moderate Refinement Needed**  
Most suggestions are accurate and relevant, requiring only moderate editing. You're refining style, adding specific details, or adjusting tone rather than rewriting entire sections. Promptless meaningfully reduces your documentation workload.

**4-6: Some Value, Significant Editing Required**  
Suggestions occasionally catch relevant changes and can serve as a starting point, but require significant editing. You're rewriting content, fixing inaccuracies, or filling in missing context. Promptless saves some time, but doesn't dramatically change your workflow.

**0-3: Creating Negative Value**  
Promptless is creating negative value. Most/all suggestions are not good enough to be a useful starting point for doc updates. Even if it's occasionally bringing up things that are relevant, I'd rather start from scratch myself.
